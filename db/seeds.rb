...
User.create name: 'Alan', status: :active, kind: :salesman, email: 'salesman2@teste.com', password: 123456
User.create name: 'David', status: :active, kind: :manager, email: 'manager@teste.com', password: 123456
